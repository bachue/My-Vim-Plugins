...
hi Error cterm=bold ctermfg=darkred ctermbg=none guifg=darkred guibg=darkgray

" The error message on the command line
hi ErrorMsg	cterm=bold ctermfg=darkred ctermbg=none guifg=darkred guibg=darkgray
...
hi Pmenu ctermfg=darkblue ctermbg=blue guifg=blue

" [Popup menu] The scrollbar
hi PmenuSbar ctermbg=none

" [Popup menu] The selected item
hi PmenuSel ctermfg=cyan ctermbg=blue guifg=green
